...
const Opt = ({
  ...
  return (
    <div className="w-full h-full absolute flex flex-col justify-center items-center transition-transform duration-300 dark:bg-[--background-dark-blue]">
      ...
      <div className="w-full sm:w-auto px-[22px] py-[36px] sm:p-[36px] rounded-[32px] shadow-lg transition-all duration-300 bg-[--background-soft-blue]">
        ...
        <div className="flex flex-col w-full overflow-hidden">
          ...
          <div className="w-full flex  justify-center items-center">
            <CustomButton
              className="group flex justify-center items-center relative bg-[--yellow] w-full h-[42px] rounded-[60px] text-base font-bold leading-[20.8px] text-[--background-dark-blue] px-[12px]"
              onclick={onOtpSubmit}
              disabled={!isValid}
            >
