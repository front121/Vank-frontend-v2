  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div
            className={` w-full flex justify-center items-center flex-row gap-2 absolute transition-all duration-300 ${
          ...
          <div
            className={`flex absolute w-full justify-center items-center transition-all duration-300 `}
          >
            <span
              className={`min-w-[70px] px-3 transition-all duration-300 ${
            ...
            <Login
              className={`w-[28px] transition-all duration-300 ${
