...
const Otp = ({ email }: { email?: string }) => {
  ...
  console.log(allTabs[activeTabIndex].name);
  ...
  return (
    <div className="w-full h-full absolute flex flex-col justify-center items-center transition-transform duration-300 dark:bg-[--background-dark-blue]">
      ...
      <div
        className={`w-full sm:max-w-[677px] py-[36px] px-[40px]  rounded-[32px] shadow-lg transition-all duration-300 bg-[--background-soft-blue]`}
      >
        <div className="relative ">
          ...
          {allTabs[activeTabIndex].name === "Email" && (
            <p className="mt-[20px] space-y-7 mb-5 w-full sm:w-[514px] text-sm sm:text-base text-[--text-body] leading-[20.8px]">
          ...
          <div className="flex justify-between mt-[20px] mb-5">
            ...
            <div className="flex flex-col justify-between pl-11">
              <p className="text-base text-[--text-body]">
                Open your <span className="font-bold">Authy Ap</span>p and scan the <span>QR</span> code
              </p>
