...
import { authSchema } from "../../SingUp/MultiStepFormView/schema/create-schema-auth";
...
const NewPassword = () => {
  ...
  return (
    <div className="w-full h-full absolute flex flex-col justify-center items-center transition-transform duration-300 dark:bg-[--background-dark-blue]">
      <Header />
      <div className="w-full sm:w-auto rounded-[32px] shadow-lg transition-all duration-300 bg-[--background-soft-blue] relative overflow-hidden">
        <form
