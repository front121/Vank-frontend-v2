...
export const SectionAccounts = ({ moreStyle,onclik }: { moreStyle?: string,onclik:any }) => {
  ...
  return (
    <div
      className={`cards-home-responsie flex flex-col 2xl:gap-[12px] 2xl:h-[137px] max-2xl:h-[121px] max-2xl:gap-[8px] max-sm:gap-[12px]  max-lg:gap-[12px] max-sm:h-[137px]  max-lg:h-[137px] ${moreStyle}`}
    >
