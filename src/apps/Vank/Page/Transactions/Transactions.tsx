...
const Transactions = () => {
  ...
  return (
    <div
      className={`responsive-transaction-main h-[708px]  w-[622px] xl:max-2xl:h-[100%] xl:max-2xl:w-[45%]  flex items-center justify-center    max-sm:h-[100%] max-lg:h-[100%]  ${
        viewHistory > 0 ? "gap-4 " : ""
      } `}
    >
      <div className="responsive-transaction h-full w-full  responsive-transaction-medium  xl:max-2xl:gap-[12px]  relative   transition-transform duration-1000 ease-out  bg-[#191E25] p-[36px]  flex flex-col  gap-[32px]  text-body  rounded-[32px]  ">
