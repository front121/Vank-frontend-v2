  ...
  return (
    <div className='h-full w-full flex flex-col justify-between   relative'>
      ...
      <SectionCardBTC img={imgEth} title={'Ethereum ETH'} subTitle={'ETH'} onClick={() => setValue(() => value == 0 ? 1 : 0)}
        moreStyleCard={`${value == 1 ? 'h-full w-full absolute z-10 ' : 'h-[120px]  hover:h-[130px] hover:bg-[#5E6061] '}`}
      ...
      <SectionCardBTC img={imgBitcoin} title={'Bitcoin BTC'} subTitle={'BTC'}  onClick={() => setValue(() => value == 0 ? 2 : 0)}
        moreStyleImg={''} moreStyleCard={`${value == 2 ? 'h-full  w-full absolute' : 'h-[120px]  hover:h-[130px] hover:bg-[#5E6061] '}`}
      ...
      <SectionCardBTC img={imgUsdt} title={'Tether USDT'} subTitle={'USDT'}  onClick={() => setValue(() => value == 0 ? 3 : 0)}
        moreStyleCard={`${value == 3 ? 'h-full  w-full absolute' : 'h-[120px]  hover:h-[130px] hover:bg-[#5E6061] '}`}
