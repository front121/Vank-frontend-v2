  ...
  return (
    <div className="h-full w-full flex flex-col justify-between relative ">
      <SectionCardBTC
        ...
        moreStyleCard={`${
          value == 1
            ? "h-full w-full absolute z-10 "
            : "h-[100px] 2xl:h-[130px]  hover:h-[130px] hover:bg-[#5E6061]  xl:max-2xl:hover:h-[100px] flex justify-center items-center"
        }`}
        btnOnClick={() => setValue(() => (value == 0 ? 1 : 0))}
        btnLabel={`${value == 1 ? "\u25B2" : "\u25BC"}`}
      ...
      <SectionCardBTC
        ...
        btnOnClick={() => setValue(() => (value == 0 ? 2 : 0))}
        btnLabel={`${value == 2 ? "\u25B2" : "\u25BC"}`}
      ...
      <SectionCardBTC
        ...
        title={"Tether USDT"}
        subTitle={"USDT"}
        onClick={() => setValue(() => (value == 0 ? 3 : 0))}
        moreStyleCard={`${
          value == 3
            ? "h-full w-full absolute z-10"
            : "h-[100px] 2xl:h-[130px]  hover:h-[130px] hover:bg-[#5E6061]  xl:max-2xl:hover:h-[100px] flex justify-center items-center"
        }`}
        btnOnClick={() => setValue(() => (value == 0 ? 3 : 0))}
        btnLabel={`${value == 3 ? "\u25B2" : "\u25BC"}`}
