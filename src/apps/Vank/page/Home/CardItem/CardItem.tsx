...
export const CardItem = ({
  ...
  return (
    <div
      className={`card flex bg-[#3E4347] justify-between hover:bg-[#5E6061] cursor-pointer px-[12px] py-[6px] rounded-[41px] items-center h-[46px]  xl:max-2xl:h-[42px]  ${moreStyle}`}
    >
