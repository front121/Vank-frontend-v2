...
const CustomInputOtp = ({
  ...
  const _className = `w-full flex justify-between items-center ${className}`;
      ...
      {otp.map((value, i) => {
        return (
          <input
            ...
            className={`w-[54px] h-[54px] rounded-[10px] bg-[#3E4347] text-center outline-none focus-visible:border-[#6F6E64] text-[--text-body] text-xl font-bold ${
