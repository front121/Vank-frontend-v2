      ...
      */}
      ...
      <nav className="h-[87%] flex flex-col justify-between 2xl:pt-[40px] sm:pt-20 xl:pt-[50px]  group-hover:w-[100%]  ">
        <div className="h-full flex flex-col  pb-[0px] justify-between group-hover:w-full ">
          <ul className="responsive-sildebar-list1 media-sidebar-icons1 flex flex-col 2xl:gap-[36px] lg:gap-5 sm:gap-[36px] xl:gap-[35px]   group-hover:w-full ">
            {listLinksHeader.map((index) => (
              ...
              >
                ...
                <p className="responsive-text 2xl:text-[16px]  mt-2   pr-[0px]  relative -right-10   h-full  duration-500 group-hover:block opacity-0 group-hover:opacity-100 xl:text-[14px]">
                  {index.text}
                </p>
              </NavLink>
            ))}
