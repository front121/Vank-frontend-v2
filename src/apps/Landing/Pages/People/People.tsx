...
const People = () => {
  ...
  return (
    <div className="w-full">
      <div className="w-full h-full xl:min-h-screen bg-[--yellow] flex flex-col items-center pt-[8rem] 2xl:pt-[11rem] pb-[8rem] px-12 xl:px-0 overflow-hidden">
        <div className="max-w-[1080px] 2xl:max-w-[1200px] w-full mx-auto flex gap-5">
          <div className="w-full xl:w-[55%] h-full">
            ...
            <h2 className="w-full xl:w-[580px] text-[30px] xl:text-[50px] leading-[40px] xl:leading-[55px] mb-4">
              <span className="font-bold">Con VankPay</span> envía dinero de
              forma rápida y segura
            </h2>
            <p className="w-full xl:w-[500px] text-[12px] xl:text-[16px] leading-[20px] xl:leading-[28px] mb-7">
              Únete a los{" "}
              <span className="font-bold">+2 millones de usuarios</span> que
              ahorran con Vank al hacer sus transferencias internacionales en
              solo minutos.
            </p>
            <div className="flex xl:flex-row flex-col-reverse items-start xl:items-center gap-4">
          ...
          <div className="relative w-full xl:w-[45%] h-full flex justify-end items-center ">
            <div className="w-[400px] xl:w-[450px] h-[480px] xl:h-[500px] flex flex-col bg-[#FFFFFF] rounded-[32px] px-5 py-7 z-10">
              <div
                className={`relative h-[120px]  xl:h-[250px] flex flex-col gap-3 mb-5`}
              >
                <div
                  className={`absolute ${
                    isOpenUsdt ? "-translate-y-0" : "translate-y-[120%]"
                  }
                  transition-all duration-1000 w-full h-[50px] xl:h-[70px] border border-[#C9CBCE] rounded-[12px] flex justify-between items-center px-4 py-2 xl:py-1`}
                >
              ...
              <div className="w-full border border-[#C9CBCE] bg-black rounded-[12px] flex flex-col justify-between items-center mb-5">
                <div className="w-full flex items-center gap-2 px-4 py-2">
                  <img src={Flash} alt="" />
                  <p className="text-[13px] xl:text-sm text-[#FFFFFF] font-bold">
              ...
              <div className="w-full flex flex-col gap-y-1 mb-5">
                <div className="flex items-center justify-between ">
                  <p className="text-[13px] xl:text-sm text-[#454745]">
                    Tasa de conversión
                  </p>
                  <p className="text-[13px] xl:text-sm font-bold">
                    1 USD = 1 USDT (0,18%)
                  </p>
                </div>
                <div className="flex items-center justify-between ">
                  <p className="text-[13px] xl:text-sm text-[#454745]">Costo</p>
                  <p className="text-[13px] xl:text-sm font-bold">
              ...
              <div className="w-full flex items-center justify-between  gap-2 xl:gap-0">
                <img src={IconInfo2} alt="" />
                <p className="w-full xl:w-[380px] text-[12px]">
            ...
            <div className="gradiente-lineal absolute -bottom-8 w-full xl:w-[450px] h-[70px] flex flex-col rounded-b-[32px] px-5 py-7" />
          </div>
        </div>
      </div>

      <div className="w-full h-full xl:min-h-screen bg-[#FFFFFF] flex flex-col items-center py-[60px] xl:py-[70px] px-12 xl:px-0 overflow-hidden">
        <div className="max-w-[1080px] 2xl:max-w-[1200px] w-full mx-auto flex ">
          <div className="w-full flex flex-col items-center justify-center">
            ...
            <h2 className="w-[650px] text-[48px] xl:text-[55px] leading-[54px] xl:leading-[64px] text-center font-medium mb-16">
              Transfiere tu dinero en{" "}
              <span className="font-bold">3 simples pasos</span>
            </h2>

            <div className="w-full grid grid-cols-1 xl:grid-cols-3 gap-12 mb-16">
              <div className="w-full h-[250px] xl:h-[500px] flex flex-row-reverse xl:flex-col items-center gap-y-7 bg-[#161616] rounded-[32px] p-[32px]">
                <div className="h-full xl:h-[60%] w-full flex items-center justify-center">
                  <img
                    src={CreateAccount3}
                    alt=""
              ...
              <div className="w-full h-[250px] xl:h-[500px] flex flex-row-reverse xl:flex-col items-center bg-[#161616] rounded-[32px] p-[32px]">
              ...
              <div className="w-full h-[250px] xl:h-[500px] flex flex-row-reverse xl:flex-col items-center bg-[#161616] rounded-[32px] p-[32px]">
                <div className="h-[60%] w-full flex items-center justify-center">
                  <img src={PayForTransfers1} alt="" className="object-cover" />
                </div>
                <div className="h-[40] w-full">
                  <h3 className="text-[20px] text-[#FFED00] mb-3">
      ...
      <div className="w-full h-full xl:min-h-screen bg-[#161616] flex flex-col items-center py-[60px] xl:py-[70px] px-12 xl:px-0 overflow-hidden">
        <div className="max-w-[1080px] 2xl:max-w-[1200px] w-full mx-auto flex flex-col gap-[164px] items-center">
          <div className="w-full flex items-center gap-5 xl:gap-0">
            <div className="w-full xl:w-[55%] h-full ">
              <h2 className="w-full xl:w-[580px] text-[40px] xl:text-[50px] leading-[45px] xl:leading-[55px] text-[#FFFFFF] mb-6 xl:mb-10">
                Lo que ves,{" "}
                <span className="text-[--yellow]">es lo que pagas</span>
              </h2>
              <div className="flex flex-col gap-y-2 mb-4 xl:mb-6">
                <h5 className="text-[16px] xl:text-[18px] text-[#FFFFFF] font-bold">
                  Comisiones
                </h5>
                <p className="w-full xl:w-[520px] text-[12px] xl:text-[14px] leading-[20px] xl:leading-[25px] text-[#FFFFFF]">
              ...
              <div className="flex flex-col gap-y-2 mb-6 xl:mb-10">
                <h5 className="text-[16px] xl:text-[18px] text-[#FFFFFF] font-bold">
                  Métodos de pago
                </h5>
                <p className="w-full text-[12px] xl:text-[14px] leading-[20px] xl:leading-[25px] text-[#FFFFFF]">
            ...
            <div className="w-full xl:w-[45%] h-full flex justify-end items-center ">
              <div className="w-full xl:w-[400px] h-[410px] xl:h-[440px] flex flex-col bg-[#F2F5F7] rounded-[32px] px-5 py-7 z-10">
                <h2 className="text-[18px] xl:text-[22px] text-[#161616] text-center mb-2 leading-none">
                  Resumen de la transferencia
                </h2>
                <div className="w-full flex items-center justify-center gap-1 mb-7">
                  <img src={Verified} alt="" />
                  <h3 className="text-sm xl:text-base text-[#FFB624]">
                    Tarifa preferencial membresía oro
                  </h3>
                </div>
                <div className="w-full h-full flex flex-col gap-y-5 bg-[#FFFFFF] p-7 rounded-[24px]">
                  <div className="flex items-center justify-between ">
                    <p className="text-[12px] xl:text-sm text-[#6A6C6A]">
                      Tú envías
                    </p>
                    <p className="text-[12px] xl:text-sm font-bold">750 USD</p>
                  </div>
                  <div className="flex items-center justify-between ">
                    <p className="text-[12px] xl:text-sm text-[#6A6C6A]">
                      Tasa
                    </p>
                    <p className="text-[12px] xl:text-sm font-bold flex gap-2">
                      <img src={TrendUp01} alt="" />1 USD = 1 USDT
                    </p>
                  </div>
                  <div className="flex items-center justify-between ">
                    <p className="text-[12px] xl:text-sm text-[#6A6C6A] flex gap-1">
                      Reciben <img src={IconInfo2} alt="" />
                    </p>
                    <p className="text-[12px] xl:text-sm font-bold">750 USDT</p>
                  </div>
                  <div className="flex items-center justify-between ">
                    <p className="text-[12px] xl:text-sm text-[#6A6C6A] flex gap-1">
                      Cargos <img src={IconInfo2} alt="" />
                    </p>
                    <p className="text-[12px] xl:text-sm font-bold">3.90 USD</p>
                  </div>
                  <div className="flex items-center justify-between ">
                    <p className="text-[12px] xl:text-sm font-bold">Total</p>
                    <p className="text-[12px] xl:text-sm font-bold">
                      753.9 USD
                    </p>
                  </div>
          ...
          <div className="w-full flex gap-16">
            <div className="relative w-full xl:w-1/2 h-full flex justify-start items-center ">
              <div className=" w-full xl:w-[390px] h-[530px] flex flex-col bg-[#F2F5F7] rounded-[32px] p-[20px] ">
                <div className="relative w-full h-full bg-[#161616] rounded-[24px] overflow-hidden">
                  <div className="w-full h-[50%] bg-[#161616] flex flex-col items-center py-5">
                    <div className="w-[40px] h-[40px] xl:w-[50px] xl:h-[50px] rounded-full bg-[#FFED00] flex justify-center items-center mb-1">
                      <img src={Send01} alt="" />
                    </div>
                    <h3 className="text-[28px] xl:text-[32px] text-[#FFFFFF] mb-1">
                      750 USD
                    </h3>
                    <p className="text-[16px] xl:text-[18px] text-[#FFFFFF] mb-1">
                      Para{" "}
                  ...
                  <div className="absolute bottom-0 right-0 w-full h-[60%] flex flex-col gap-y-5 bg-[#FFFFFF] p-7 rounded-[24px]">
                    ...
                    <div className="w-full flex items-center justify-center gap-2 py-2 xl:py-3 px-5 rounded-[40px] bg-[--yellow] text-[--background-dark] cursor-pointer">
                      <span className="font-bold">Confirmar</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="absolute w-[190px] h-[190px] xl:w-[280px] xl:h-[280px] xl:-top-[75px] -top-[55px] -right-20">
                <img src={BellNotification} alt="" className="" />
              </div>
            </div>
            <div className="w-full xl:w-1/2 h-full xl:pl-12">
              <h2 className="w-full xl:w-[480px] xl:text-[40px] xl:leading-[45px] text-[30px] leading-[38px] text-[#FFFFFF] mb-5">
                <span className="text-[--yellow]">
                  Conoce el estado de tus transferencias
                </span>{" "}
                en tiempo real
              </h2>
              <p className="text-sm xl:text-base leading-[25px] text-[#FFFFFF] mb-6">
              ...
              <div className="flex flex-col  gap-3 mb-7">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm xl:text-base leading-[28px] text-[#FFFFFF]">
                    Aplicación móvil.
                  </span>
                </div>
                <div className="flex items-center gap-3">
      ...
      <div className="w-full h-full xl:min-h-screen bg-[#FFFFFF] py-[60px] xl:py-[70px] px-12 xl:px-0 overflow-hidden">
        <div className="relative max-w-[1080px] 2xl:max-w-[1200px] mx-auto flex gap-12 bg-[#FFED00] rounded-[32px]">
          <div className="w-full xl:w-1/2 h-full flex flex-col justify-center rounded-[32px] pl-[42px] pr-[42px] xl:pr-0 py-[68px]">
            <h3 className="max-w-max xl:w-[130px] text-lg leading-none border-b-2 border-[#FFFFFF] text-[#161616] mb-5">
              Tu primera vez
            </h3>
          ...
          <div className="w-1/2 xl:h-full h-[90%] flex flex-col justify-center rounded-[32px]  max-[1279px]:absolute static bottom-0  rotate-12 xl:rotate-0 opacity-45 xl:opacity-100 right-2 py-[30px]">
            <img
              src={Percentage}
              alt=""
      ...
      <div className="w-full h-full xl:min-h-screen bg-[#F2F5F7] flex flex-col items-center py-[60px] xl:py-[70px] px-12 xl:px-0 overflow-hidden">
        <div className="max-w-[1080px] 2xl:max-w-[1200px] w-full mx-auto flex flex-col gap-[164px] items-center">
          <div className="w-full flex flex-col items-center">
            <span className="text-lg text-[#161616] border-b-2 border-[--yellow] leading-none mb-4 xl:mb-3">
              Opciones de pago
            </span>
            <h2 className="w-full xl:w-[900px] text-[35px] xl:text-[40px] leading-[42px] xl:leading-[50px] text-center font-medium mb-16">
            ...
            <div className="w-full grid grid-cols-2 gap-[32px]">
              <div className="w-full h-full xl:h-[240px] flex flex-col items-center gap-6 rounded-[32px] bg-[#FFFFFF] p-[40px]">
                <div className="flex justify-around gap-6">
                  <div className="min-w-[47px] h-[47px] flex justify-center items-center rounded-full bg-[#FFED00]">
                    <img src={BankUser} alt="" />
                  </div>
                  <div className="w-full xl:w-[370px] space-y-4">
                    <h2 className="text-[20px] xl:text-[24px] leading-[30px] xl:leading-[32px]">
                      Tarjeta Débito o Crédito
                    </h2>
                    <p className="text-sm xl:text-base leading-[23px] xl:leading-[28px]">
                      Usa tu tarjeta débito o crédito para recargar tu cuenta de
                      VankPay sin ningún costo.
                    </p>
                    <div className="max-w-max hidden xl:flex items-center gap-2 py-3 px-5 rounded-[40px] bg-[#161616] text-[#FFED00] cursor-pointer text-sm ">
                ...
                <div className="w-full flex xl:hidden items-center justify-center gap-2 py-3 px-5 rounded-[40px] bg-[#161616] text-[#FFED00] cursor-pointer text-sm">
                  <span className="font-bold">Vincula tus tarjetas</span>
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="w-full h-full xl:h-[240px] flex flex-col items-center gap-6 rounded-[32px] bg-[#FFFFFF] p-[40px]">
                <div className="flex justify-around gap-6">
                  ...
                  <div className="w-full xl:w-[370px] ">
                    ...
                    <p className="text-sm xl:text-base leading-[23px] xl:leading-[28px] mb-7">
              ...
              <div className="w-full h-full xl:h-[240px] flex flex-col items-center gap-6 rounded-[32px] bg-[#FFFFFF] p-[40px]">
                <div className="flex justify-around gap-6">
                  <div className="min-w-[47px] h-[47px] rounded-full flex justify-center items-center bg-[#FFED00]">
                  ...
                  <div className="w-full xl:w-[370px] space-y-4">
                    ...
                    <p className="text-sm xl:text-base leading-[23px] xl:leading-[28px]">
                      Dirígete a uno de nuestros puntos autorizados para
                      recargar tu cuenta con dinero en efectivo
                    </p>
                    <div className="max-w-max hidden xl:flex items-center gap-2 py-3 px-5 rounded-[40px] bg-[#161616] text-[#FFED00] cursor-pointer text-sm ">
                      <span className="font-bold">Vincula tus tarjetas</span>
                      <svg
          ...
          <div className="w-full flex flex-col items-center gap-0 xl:gap-9">
            <span className="text-lg text-[#161616] border-b-2 border-[--yellow] leading-none mb-3">
              Métodos de pago
            </span>
            <div className="w-full flex items-center gap-16">
              <div className="w-full xl:w-1/2 h-full ">
                <h2 className="w-full xl:w-[480px] text-[30px] xl:text-[48px] leading-[38px] xl:leading-[48px] text-[#161616] mb-5">
                  Vincula tu cuenta <span className="font-bold">Vank</span> como
                  una cuenta tradicional
                </h2>
                <p className="text-sm xl:text-base leading-[25px] text-[#161616] mb-6">
                ...
                <div className="flex flex-col  gap-3 mb-7">
                  <div className="flex gap-3">
                    <img src={CheckIcon} alt="" className="w-[28px] h-[28px]" />
                    <span className="text-sm xl:text-[17px] leading-[23px] text-[#161616]">
              ...
              <div className="w-full xl:w-1/2 h-full flex justify-center items-center">
                <div className=" w-full xl:w-[500px] h-[550px] flex flex-col bg-transparent xl:bg-[#FFFFFF] rounded-[32px] overflow-hidden">
                  <img
                    src={Content}
                    alt=""
      ...
      <div className="w-full h-full xl:min-h-screen bg-[#161616] flex flex-col items-center py-[60px] xl:py-[70px] px-12 xl:px-0 overflow-hidden">
        <div className="max-w-[1080px] 2xl:max-w-[1200px] w-full mx-auto flex ">
          <div className="w-full flex items-center xl:gap-[96px] ">
            <div className="w-full xl:w-[40%] z-10 xl:z-0">
              <h2 className="w-full xl:w-[400px] text-[48px] xl:text-[55px] text-[#FFFFFF] leading-[60px] xl:leading-[64px] text-left ml-3 xl:ml-0 font-medium mb-7">
              ...
              <div className="w-full flex gap-5 mb-[28px]">
                ...
                <div className="w-full space-y-3 xl:space-y-1 py-1">
                  <h2 className="text-[17px] xl:text-[19px] leading-[32px] text-[#FFFFFF]">
                    Protección
                  </h2>
                  <p className="w-[350px] xl:w-full text-[13px] xl:text-sm leading-[23px] text-[#FFFFFF]">
              ...
              <div className="w-full flex gap-5 mb-[28px]">
                ...
                <div className="w-full space-y-3 xl:space-y-1 py-1">
                  <h2 className="text-[17px] xl:text-[19px] leading-[25px] xl:leading-[32px] text-[#FFFFFF]">
              ...
              <div className="w-full flex gap-5 mb-[28px]">
                ...
                <div className="w-full space-y-3 xl:space-y-1 py-1">
                  <h2 className="text-[17px] xl:text-[19px] leading-[28px] xl:leading-[32px] text-[#FFFFFF]">
                    Licenciado
                  </h2>
                  <p className="w-[350px] xl:w-full text-[13px] xl:text-sm leading-[23px] text-[#FFFFFF]">
            ...
            <div className="w-[60%] xl:static absolute -right-12 rotate-6 mt-20 xl:mt-0 opacity-35 xl:opacity-100">
              <img
                src={SecurityIcon}
                alt=""
                className="w-full h-full object-contain"
      ...
      <div className="w-full h-full xl:min-h-screen bg-[#F2F5F7] py-[60px] xl:py-[70px] px-12 xl:px-0 overflow-hidden">
        <div className="max-w-[1080px] 2xl:max-w-[1200px] mx-auto flex items-end xl:gap-x-12 ">
          <div className="w-full xl:w-1/2 h-[530px] flex flex-col justify-center rounded-[32px] xl:pl-[32px] py-[68px]">
            ...
            <div className="relative w-full mb-3 ">
              <h2 className="relative text-[30px] leading-[40px] xl:text-[43px] xl:leading-[48px] mb-4 text-[#161616] z-10">
                Realiza transferencias internacionales entre Colombia, Perú y
                Chile
              </h2>
              <div className="absolute w-full h-[30px] xl:h-[40px] bg-[#FFED00] bottom-[7px] xl:bottom-[10px]"></div>
            </div>
            <div className="w-[300px] xl:w-[422px] xl:h-[400px] ">
              <img
                src={CurrencyLeaks}
                alt=""
                className="w-full h-full object-contain"
          ...
          <div className="w-full xl:w-1/2 flex flex-col justify-center rounded-[32px]">
            <img
              src={GrayMap}
              alt=""
              className="w-full h-full object-contain"
